package rpg.entities.enemies.Nebulon;
...
public class Nebulon extends Enemy {
    ...
    /**
     * Agregar constructor para Nebulon
     */
    public Nebulon() {

        super("Nebulon");
        ImageCache.addImage("Nebulon", "Enemies/Nebulon.png");
    }
    ...
    @Override
    public void getLoot() {
        System.out.println("The Nebulon drops a bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El Nebulon te ataca ferozmente y te hace 4 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El Nebulon te planta un abrazacaras y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("Nebulon");
    }
}
