package rpg.entities.enemies.CosmicHerbivore;
...
public class CosmicHerbivore extends Enemy {
    ...
    /**
     * Agregar constructor para CosmicHerbivore
     */

    public CosmicHerbivore() {

        super("CosmicHerbivore");
        ImageCache.addImage("CosmicHerbivore", "Enemies/CosmicHerbivore.png");
    }
    ...
    @Override
    public void getLoot() {
        System.out.println("The CosmicHerbivore drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El CosmicHerbivore novato lanza una roca y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El CosmicHerbivore novato muerde salvajemente y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("CosmicHerbivore");
    }
}