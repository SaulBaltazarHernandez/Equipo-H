package rpg.entities.enemies.Astrodevourer;
...
public class Astrodevourer extends Enemy {
    ...
    /**
     * Agregar constructor para Astrodevourer
     */

    public Astrodevourer() {
            super("Astrodevourer");
            ImageCache.addImage("Astrodevourer", "Enemies/Astrodevourer.png");
        }
    ...
    @Override
    public void getLoot() {
        System.out.println("The Astrodevourer drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El Astrodevourer novato lanza un rayo y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El Astrodevourer novato muerde salvajemente y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("Astrodevourer");
    }
    }
