package rpg.entities.enemies.GalacticBehemoth;
...
public class GalacticBehemoth extends Enemy {
    /**
     * Agregar constructor para GalacticBehemoth
     */

    public GalacticBehemoth() {

        super("GalacticBehemoth");
        ImageCache.addImage("GalacticBehemoth", "Enemies/GalacticBehemoth.png");
    }
    ...
    @Override
    public void getLoot() {
        System.out.println("The GalacticBehemoth drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El GalacticBehemoth te ataca con su pistola de plasma y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El GalacticBehemoth invoca a otros  y te hacen 6 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("GalacticBehemoth");
    }
}
