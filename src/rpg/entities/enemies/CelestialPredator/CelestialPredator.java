package rpg.entities.enemies.CelestialPredator;
...
public class CelestialPredator extends Enemy {
    ...
    /**
     * Agregar constructor para CelestialPredator
     */

    public CelestialPredator() {

        super("CelestialPredator");
        ImageCache.addImage("CelestialPredator", "Enemies/CelestialPredator.png");
    }
    ...
    @Override
    public void getLoot() {
        System.out.println("The CelestialPredator drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El CelestialPredator lanza se lanza al ataque  y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El CelestialPredator muerde todo tu cuerpo y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("CelestialPredator");
    }
}
